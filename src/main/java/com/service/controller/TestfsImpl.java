...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-16T01:48:25.507Z")

@RestSchema(schemaId = "testfs")
@RequestMapping(path = "/testfs", produces = MediaType.APPLICATION_JSON)
public class TestfsImpl {

    @Autowired
    private TestfsDelegate userTestfsDelegate;
    ...
    public Integer add( @RequestParam(value = "a", required = true) Integer a, @RequestParam(value = "b", required = true) Integer b){
        ...
        return userTestfsDelegate.add(a, b);
    }
    ...
    public String sayHei( @RequestHeader(value="name", required=true) String name){
        ...
        return userTestfsDelegate.sayHei(name);
    }
    ...
    public String sayHello( @PathVariable("name") String name){
        ...
        return userTestfsDelegate.sayHello(name);
    }
    ...
    public String sayHi( @RequestParam(value = "name", required = true) String name){
        ...
        return userTestfsDelegate.sayHi(name);
    }
    ...
    public String saySomething( @RequestParam(value = "prefix", required = true) String prefix, @RequestBody Person user){
        ...
        return userTestfsDelegate.saySomething(prefix, user);
    }
